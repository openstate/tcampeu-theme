...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-4 col-md-offset-2 text-center">
      ...
      <p class="frontpage-content-text">
        You can join the online App Competition, either by building an application that improves transparency and opens the black box of EU decision-making, or submitting apps that use European open data (e.g. on mobility, public health, education or the environment) to improve the every lives of Europeans.
      </p>
