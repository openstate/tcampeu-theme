...
NODE_CONTAINER = 'c-nodejs-tcampeu'

def deploy():
    with cd('/home/projects/wordpress/www/wp-mu/wp-content/themes/tcampeu-theme'):
        sudo('git pull git@github.com:openstate/tcampeu-theme.git')
